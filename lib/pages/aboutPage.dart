      ...
      body: Center(
        child: Column(
          ...
          children: [
            InkWell(
              onTap: () {
                launchURL('https://radiobarbaros.com/');
              },
              child: Image(
                width: 50.w,
            ...
            InkWell(
              onTap: () {
                launchURL('https://www.facebook.com/groups/radiobarbaros');
              },
              child: Image(
                width: 50.w,
            ...
            InkWell(
              onTap: () {
                launchURL('https://www.instagram.com/radiobarbaros/');
              },
              child: Image(
                width: 50.w,
            ...
            InkWell(
              onTap: () {
                launchURL('https://youtube.com/channel/UCL78bVyALbhFRAPeIfltIkg');
              },
              child: Image(
                width: 50.w,
            ...
            InkWell(
              onTap: () {
                launchURL('https://vk.com/radiobarbaros');
              },
              child: Image(
                width: 50.w,
